...
public class SimulationRevenueServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        // 1. Forcer l'encodage en UTF-8 pour éviter les problèmes de caractères avec les accents français
        request.setCharacterEncoding("UTF-8");
        response.setCharacterEncoding("UTF-8");

        // 2. Récupération des données du formulaire grâce à l'attribut 'name' de tes inputs/selects
        ...
        // 5. Stockage des données dans l'objet 'request' pour les envoyer à la page de résultat
