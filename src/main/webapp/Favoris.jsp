...
<body>
 <div class="app-container">
    ...
    <img src="assets/logo.png" alt="Mon_Activite Logo" style="max-width: 80%; max-height: 80%; object-fit: contain;">
</div>
    ...
    <li><a href="#" class="nav-item-link"><i class="bi bi-grid-1x2"></i> Liste Activité</a></li>
    <li><a href="#" class="nav-item-link"><i class="bi bi-check-square"></i> Recommandation</a></li>

    <!-- Favoris devient l'élément actif -->
    <li>
        ...
        <div class="main-panel">
            ...
            <div>
                <div class="d-flex justify-content-between align-items-center mb-5">
                    <h1 class="fw-bold mb-0" style="color: #000; font-size: 36px;">Mes Favoris</h1>
                    
                    <div class="user-profile-badge">
                        <i class="bi bi-person-circle"></i>
                        <span class="fw-semibold text-dark">Yattus</span>
                    </div>
                </div>
