...
/* Le style magique pour arrondir ton image */
.logo-arrondi {
    max-width: 80%;
    max-height: 80%;
    object-fit: contain;
    
    /* C'est ces deux lignes qui coupent les bords carrés de ton image */
    border-radius: 12px;       /* Arrondit les angles (mets 50% si tu veux un cercle parfait) */
    background-color: white;   /* Optionnel : ajoute un fond blanc si ton logo a besoin de ressortir */
    padding: 5px;              /* Optionnel : laisse un petit espace entre le logo et le bord arrondi */
}
